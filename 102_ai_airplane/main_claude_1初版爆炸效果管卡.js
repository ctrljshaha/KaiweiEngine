...
labScore.setTextColor(1, 1, 0.3, 1);
...
labBest.setTextColor(0.8, 0.8, 0.8, 0.8);
...
labLevel.setTextColor(0.3, 1, 0.6, 1);
...
labLife.setTextColor(1, 0.5, 0.5, 0.9);
labLife.setText("生命值  ❤ ❤ ❤");
...
labGameOver.setColor(0, 0, 0, 0.8);
labGameOver.setFont("font/st.ttf", 30);
labGameOver.setTextColor(1, 0.3, 0.3, 1);
...
labFinalScore.setTextColor(1, 1, 0.5, 1);
...
labPause.setColor(0, 0, 0, 0.7);
labPause.setFont("font/st.ttf", 26);
labPause.setTextColor(1, 1, 0, 1);
...
labTip.setTextColor(0.6, 0.6, 0.6, 0.7);
...
function playerHit() {
    ...
    // 更新生命显示
    var hearts = life >= 3 ? "❤ ❤ ❤" : life === 2 ? "❤ ❤" : life === 1 ? "❤" : "✕";
